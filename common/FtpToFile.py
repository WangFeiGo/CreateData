...
if __name__ == "__main__":
    ...
    # ===========================================================================
    # 下载单个文件
    # my_ftp.download_file("D:/mycodes/download/1.rar", "/wangfei/1.rar")
    # 下载目录
    # my_ftp.download_file_tree("D:/mycodes/download/", "/wangfei/")
    # ===========================================================================
    # 上传单个文件
    # my_ftp.upload_file("D:/mycodes/upload/1.rar", "/wangfei/1.rar")
    # 上传目录
    my_ftp.upload_file_tree("D:/mycodes/upload/", "/wangfei/")
    # ===========================================================================
    my_ftp.close()